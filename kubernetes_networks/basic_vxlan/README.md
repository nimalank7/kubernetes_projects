...
Bridges on both `host_a` and `host_b` are on an overlay network (`10.200.0.0/24`). The VTEPs are on an underlay network (`10.0.0.0/24`). VTEP encapsulates the Layer 2 packets and sends it from `enp0s8`.

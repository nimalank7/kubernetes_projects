...
This is a mutating admission webhook which modifies a deployment to have 3 replicas. See https://kubernetes.io/docs/reference/access-authn-authz/extensible-admission-controllers/
